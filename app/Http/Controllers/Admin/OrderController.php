...
class OrderController extends Controller
{
    ...
    public function ordersByStatus($status)
    {
        ...
        if ($status == 'Delivered' || $status == 'Customer Confirm' || $status == 'Customer On Hold' || $status == 'Request to Return' || $status == 'Paid' || $status == 'Return' || $status == 'Lost' || $status == 'Return Received') {
